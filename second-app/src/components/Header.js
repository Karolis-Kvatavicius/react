          ...
          <div className="row">
            ...
            <div className="col-sm-4 offset-md-1 py-4">
              ...
              <ul className="list-unstyled">
                <li><a href="/react" className="text-white">Follow on Twitter</a></li>
                <li><a href="/react" className="text-white">Like on Facebook</a></li>
                <li><a href="/react" className="text-white">Email me</a></li>
              </ul>
            </div>
          </div>
        </div>
